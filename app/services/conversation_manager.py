...
class ConversationManager:
    ...
    @staticmethod
    async def start_session(question: str, classification: Dict[str, Any]) -> StepByStepSession:
    ...
    @staticmethod
    async def continue_conversation(session: StepByStepSession, user_response: str, llm_service) -> str:
